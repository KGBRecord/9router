...
import { Card, Button, Badge, Input, Modal, CardSkeleton, OAuthModal, KiroOAuthWrapper, CursorAuthModal, XiaomiMimoAuthModal, IFlowCookieModal, GitLabAuthModal, Toggle, Select, EditConnectionModal, NoAuthProxyCard, TokenSaverStrategyCard, ConfirmModal } from "@/shared/components";
...
export default function ProviderDetailPage() {
  ...
  return (
    <div className="flex min-w-0 flex-col gap-6 px-1 sm:gap-8 sm:px-0">
      ...
      {/* Connections */}
      <TokenSaverStrategyCard providerId={providerId} />
      {isFreeNoAuth ? (
